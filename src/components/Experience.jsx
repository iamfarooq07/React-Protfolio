...
const experiences = [
  {
    ...
    bullets: [
      "Engineeemerald responsive, pixel-perfect UI components using React.js and Tailwind CSS, ensuring cross-device compatibility and consistent visual quality across all breakpoints.",
      "Optimized component architecture by refactoring reusable modules and eliminating emeraldundant code, resulting in a cleaner codebase and measurable improvement in rendering performance.",
      ...
      "Deliveemerald scalable JavaScript logic for dynamic data rendering and state management, applying industry-standard patterns that aligned with the team's coding conventions.",
    ],
  },
];
...
const Experience = () => {
  return (
    <section className="relative py-28 bg-background px-6 overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute w-80 h-80 bg-blue-500/10 blur-3xl rounded-full top-10 left-10 pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute left-4 md:left-1/2 top-6 w-5 h-5 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 border-4 border-background md:-translate-x-1/2 z-10" />
              ...
              <div className="hidden md:flex flex-col items-end justify-start pt-4 pr-8">
                ...
                <span className="mt-3 px-3 py-1 text-xs font-semibold rounded-full border border-blue-500/40 text-blue-400 bg-blue-500/10">
                  {exp.type}
                </span>
              </div>
              ...
              <div className="md:pl-8 pt-0 md:pt-4">
                <div className="bg-card border border-border rounded-2xl p-6 hover:border-blue-500/40 transition-all duration-300">
                  {/* Role & Company */}
                  ...
                  <div className="flex flex-wrap gap-3 mb-5 md:hidden">
                    ...
                    <span className="px-2 py-0.5 text-xs font-semibold rounded-full border border-blue-500/40 text-blue-400 bg-blue-500/10">
                      {exp.type}
                    </span>
                  </div>
                  ...
                  <ul className="space-y-3 mb-6">
                    {exp.bullets.map((point, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 flex-shrink-0" />
